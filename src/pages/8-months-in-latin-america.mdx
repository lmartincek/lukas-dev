...
export const title = "8 Months in Latin America: What I Learned & Experienced"

<ArticleLayout description="From the Andes to the Amazon, 8 months in Latin America brought challenges and growth—learning Spanish in Guatemala, crossing 9 countries, hiking a 6000m peak, battling salmonella in the jungle, and motorbiking to Machu Picchu."
...
<h1 className="font-serif text-center text-[2rem] md:text-[2.25rem] tracking-tight text-primary">{title}</h1>
    <Image class="gallery-image w-[350px] h-[380px] mx-auto cursor-pointer shadow-md mt-8"
