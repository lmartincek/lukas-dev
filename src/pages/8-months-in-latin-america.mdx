...
export const title = "A Journey Through Latin America: 8 Months of Adventure, Growth, and Unexpected Lessons"

<ArticleLayout description="An article about 8 months of travelling thorugh Latin America"
               title={title}>
<h1 className="font-serif text-center text-[2rem] tracking-tight text-primary">{title}</h1>
    <ImageWrapper src={"/photos/my-route.webp"} alt={"Latin America and the way I crossed"}/>
    ___
    ## 1. DECIDING TO QUIT MY JOB
    In February 2024, I started thinking about resigning. I was working for a medium-sized company based in Slovakia,
    ...
    * **Week 4** - Turns out, that intense third week paid off. I finally grasped the real meaning of immersion.
    ...
    <Carousel images={[
        ...
        { src: "/photos/guatemala/acatenango-selfie.webp", alt: "Selfie with active Volcan de Fuego. Back in 2016, its eruption killed more than 400 people."},
    ...
    <ImageWrapper alt='"This is it. These are the places I need to aim for on my travels."' src={"/photos/colombia/nuqui.webp"}/>
    ...
    **“Double infection. Giardia and Salmonella,”** he said.
    ...
    <ImageWrapper src={"/photos/peru/after-salmonella.webp"} alt={"yeah Amazon.. I think I’ll never forget."}/>
    ___
    ...
    **Their guide, Erwin, was 27, climbed this mountain 3-4 times a week**, and lived in a village near the lower camp.
    ...
    <ImageWrapper src={"/photos/bolivia/ervin.webp"} alt={'Ervin, my new guide'}/>
    ...
    <Carousel images={[
        ...
        { src: "/photos/brasil/homeless.webp" , alt: "Homelessness is a big problem in Brazil" },
    ...
    <Carousel images={[
        { src: "/photos/brasil/chapada-valley.webp" , alt: "On the summit. 6088m" },
        { src: "/photos/brasil/chapada-selfie.webp" , alt: "On the summit. 6088m" },
        { src: "/photos/brasil/chapada-house.webp" , alt: "On the summit. 6088m" },
    ]}>
