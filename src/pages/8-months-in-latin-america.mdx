...
export const title = "5000 words displaying 8 months of travelling through Latin America"

<ArticleLayout description="5000 words displaying 8 months of travelling through Latin America"
               img="/photos/my-route.webp"
               title={title}>
<h1 className="font-serif text-center text-[2rem] md:px-8 tracking-tight text-primary">{title}</h1>
